(ns marketentry.store
  "SSoT for the FIN market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems FI" :portal "Hilma"
             ...
             :requires-ytunnus? true :ytunnus-verified? true
             :drafted? false :submitted? false
             :jurisdiction "FIN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Hilma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-ytunnus? true :ytunnus-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Hilma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "FIN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Hilma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "FIN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Hilma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-ytunnus? true :ytunnus-verified? false
             :drafted? false :submitted? false
             :jurisdiction "FIN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Hilma"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               ...
                               requires-ytunnus? ytunnus-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ytunnus?)    (assoc :engagement/requires-ytunnus? requires-ytunnus?)
    (some? ytunnus-verified?)    (assoc :engagement/ytunnus-verified? ytunnus-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ytunnus? :engagement/ytunnus-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ytunnus? (boolean (:engagement/requires-ytunnus? m))
     :ytunnus-verified? (boolean (:engagement/ytunnus-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-fin"})
